...
def get_args_parser():
    ...
    # Loss
    parser.add_argument('--no_aux_loss', dest='aux_loss', action='store_false', default=False, #! debug 
    ...
    parser.add_argument('--start_epoch', default=0, type=int, metavar='N',
                        help='start epoch')
    parser.add_argument('--eval', action='store_true', default=True) #! debug
...
if __name__ == '__main__':
    ...
    # main.py --coco_path /path/to/coco 
    # --coco_panoptic_path /path/to/coco_panoptic 
    # --dataset_file coco_panoptic --output_dir /output/path/box_model
